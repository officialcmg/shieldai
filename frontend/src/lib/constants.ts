...
export const ENVIO_GRAPHQL_ENDPOINT = process.env.NEXT_PUBLIC_ENVIO_GRAPHQL_ENDPOINT || 'https://indexer.dev.hyperindex.xyz/4ee1582/v1/graphql'

// ShieldAI Backend API URL
export const BACKEND_API_URL = process.env.NEXT_PUBLIC_BACKEND_API_URL || 'https://shieldai.up.railway.app'
